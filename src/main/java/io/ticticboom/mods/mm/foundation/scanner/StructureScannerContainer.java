...
public class StructureScannerContainer implements Container {

    private final StructureScannerItemHandler handler;

    public StructureScannerContainer(StructureScannerItemHandler handler) {
